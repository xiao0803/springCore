...
public class LoggingAspect {
     ...
     * 这里只是做一个示例，并没有使用
     */
    @Pointcut("execution(* com.example.aop.inte.Person.*(..))")
     ...
     */
    @Before("execution(public void com.example.aop.impl.PersonImpl.sayHello())")
     ...
     * @throws Throwable
     */
    @Around("execution(public void com.example.aop.impl.PersonImpl.sayBye(String))")
